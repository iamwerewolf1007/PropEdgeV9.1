#!/bin/bash
cd /Users/salman/Documents/GitHub/PropEdgeV9.1
...
if [ "$CURRENT_HOUR" -ge "$TARGET_HOUR" ]; then
    /Library/Frameworks/Python.framework/Versions/3.13/bin/python3 /Users/salman/Documents/GitHub/PropEdgeV9.1/batch_predict.py 3
fi
