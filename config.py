"""
PropEdge V9.1 — Configuration & Shared Constants
"""
...
_month = _now.month
ET = timezone(timedelta(hours=-4 if 3 <= _month <= 10 else -5))
UK = timezone(timedelta(hours=1 if 3 <= _month <= 10 else 0))
...
# ─── REPO ─────────────────────────────────────────────────────
REPO_DIR = Path.home() / 'Documents' / 'GitHub' / 'PropEdgeV9.1'
